...
None — diagnosis requires live GSC data. Prior runs on 2026-08-13 and 2026-08-20 failed for the same reason; no pages were thrash-candidates from prior SEO edits.

## What changed

Failure report only (`content/reports/gsc-review-2026-08-27.md`). No page content changes.
